...
class data:
    ...
    def search(self,start_time,end_time,vehicle_type):
        ...
        """
        filtered_df = self.df[(self.df['DerectionTime_O']>=start_time)&(self.df['DerectionTime_D']<=end_time)&(self.df['VehicleType']==vehicle_type)].copy()
...
if __name__ == '__main__':
    ...
    traffic_df = pd.read_csv("/Users/chris/Documents/GitHub/HKUST_DDM_MSDM5001_PROJECT2/Traffic_data/TDCS_M06A_20190830_080000.csv",names = colnames)
